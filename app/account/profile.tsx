  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <TextInput style={styles.input} placeholder="Entrez votre prénom" placeholderTextColor={DriverColors.muted} />
        <TextInput style={styles.input} placeholder="Entrez votre nom de famille" placeholderTextColor={DriverColors.muted} />

        <Text style={styles.sectionTitle}>Ajoutez votre e-mail pour les mises à jour et l’assistance (facultatif)</Text>
        ...
        <TouchableOpacity style={styles.checkboxRow}>
          ...
          <Text style={styles.checkboxText}>
            ...
            <Text style={styles.linkText}> Politique de confidentialité</Text> de Ziwago.
          </Text>
        </TouchableOpacity>
